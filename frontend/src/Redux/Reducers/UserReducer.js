...
export const updateReducer = createReducer(
  {},
  {
    ...
    ADD_SKIILS_REQUEST: (state) => {
      state.loading = true;
    },
    ADD_SKIILS_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    ADD_SKIILS_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },

    DELETE_SKILLS_REQUEST: (state) => {
      state.loading = true;
    },
    DELETE_SKILLS_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    DELETE_SKILLS_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },
